...
<script type="text/javascript">
  var values = ${rmgAdminDashboardResponse};
...
<body id="appDashPage">
                      ...
                      <div class="doc-requests">
                        ...
                        <thead>
                          <tr>
                            ...
                            <th>View / Edit</th>
                            <th class="text-center" >RMG Admin (Select All) &nbsp <input type="checkbox" id="selectAll"></th>
                          </tr>
                        </thead>
                        <tbody>
                         <%--  <tr>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="col-md-3 text-right">
                        <button class="btn btn-default btn-sm" id="rmgAdminReject" type="button" data-toggle="modal" data-target="#rejectionReason">Reject RMG</button>
                        <button class="btn btn-default btn-sm" id="rmgAdmin-approve" type="button" data-toggle="modal" data-target="#background-Approve">Approve RMG Admin</button>
                     </div>
                  </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer  text-center">
            <button type="button" class="btn btn-primary" data-dismiss="modal" id="rmgAdminApprove">Yes</button>
  ...
  <!-- Model : Rejection Reason -->
    ...
    <script src="${context}/resources/js/rmgadmindashboard.js"></script>
</body>
</html>