...
<script type="text/javascript">
  var values = ${workflowStatsResponse};
...
<body id="appDashPage">
            ...
            <div class="col-md-12">
              <div class="app-content-box recent-doc-list">
                ...
                <div class="filters-sections">
                    ...
                    <div class="col-sm-3">
                    	<select class="form-control input-sm filer1" id="progressFilter">
                    		<option>RMG Approved</option>
                    		<option>RMG Not Approved</option>
                    		<option>RMG Admin Not Approved</option>
                    		<option>RMG Admin Approved</option>
                    		<option>HR Not Approved</option>
 ...
 <!-- Model : mail -->
    ...
    <script src="${context}/resources/js/workflowStats.js"></script>
</body>
</html>